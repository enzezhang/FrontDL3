...
#rm -r test_output
#mkdir test_output
#python /home/zez/data2/pytorch_deeplab/pytorch-deeplab-xception/inference.py ${work_root} ${work_root}/para.ini ${work_root}/list/test.txt --backbone resnet --workers 1 --cuda --useBN --batchSize 1 --resume ${work_root}/resnet_hist_eq_ALOS1_JI_Kanger_May19.tar
#python /home/zez/data2/pytorch_deeplab/pytorch-deeplab-xception/inference.py ${work_root} ${work_root}/para.ini ${work_root}/list/test.txt --backbone drn --workers 1 --cuda --useBN --batchSize 1 --resume ${work_root}/drn_default_hist_eq_ALOS1_JI_Mar27.tar
...
while (($i<$count))
	...
	ogr2ogr -f "GMT" ${work_root}/post_output/${temp2}_out.gmt ${work_root}/post_output/${temp2}_out.shp
        ...
        python ${eo_dir}/rm_small_polygon.py --threshold 1000 --input_shape ${work_root}/post_output/${temp2}_out.shp --output_shape ${work_root}/post_process_shape/${temp2}_out_post.shp
        ...
        python /home/zez/test_deep_learning/u_net/Unet_pytorch-master_Dec5/point_in_polygon.py --input ${work_root}/post_process_gmt/${temp2}.gmt --polygon ${work_root}/post-processing/polygon_for_truncation/cut_polygon.gmt --output ${work_root}/in_polygon_gmt/${temp2}.gmt
